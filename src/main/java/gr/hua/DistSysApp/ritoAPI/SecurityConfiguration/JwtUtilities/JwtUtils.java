package gr.hua.DistSysApp.ritoAPI.SecurityConfiguration.JwtUtilities;
...
public class JwtUtils {
    ...
    private String SECRET_KEY = Base64.getUrlEncoder().encodeToString("I_<3_RNS_GR33K_FAN_PAGE".getBytes());
